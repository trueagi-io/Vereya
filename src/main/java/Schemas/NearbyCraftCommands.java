 ...
 *                   &lt;element name="command" type="{http://ProjectMalmo.microsoft.com}NearbyCraftCommand" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/choice>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlRootElement(name = "NearbyCraftCommands")
public class NearbyCraftCommands {

    @XmlElement(name = "ViewToCraft", defaultValue = "false")
    protected Boolean viewToCraft;
    @XmlElement(name = "ModifierList")
    protected NearbyCraftCommands.ModifierList modifierList;
     ...
     * @return
     *     possible object is
     *     {@link NearbyCraftCommands.ModifierList }
     *     
     */
    public NearbyCraftCommands.ModifierList getModifierList() {
        return modifierList;
    }
     ...
     *     
     */
    public void setModifierList(NearbyCraftCommands.ModifierList value) {

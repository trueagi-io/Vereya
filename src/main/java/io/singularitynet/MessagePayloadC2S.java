...
public record MessagePayloadC2S(VereyaMessage msg) implements CustomPayload {
    ...
    public static final CustomPayload.Id<MessagePayloadC2S> ID = new CustomPayload.Id<>(NetworkConstants.CLIENT2SERVER);
